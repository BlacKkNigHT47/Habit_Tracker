...
def index():
    ...
    return render_template("index.html", habits=habits_on_date, title='Home', selected_date=selected_date, completions=completions)
...
def add_habit():
    ...
    return render_template("add_habit.html", title='Add habit', selected_date=today)
